...
const virtutalMachinesApiClient = apiClient.create({
...
// virtutalMachinesApiClient.interceptors.request.use(
//     (config) => {
...
// virtutalMachinesApiClient.interceptors.response.use(
//     (response) => {
...
export default virtutalMachinesApiClient;
